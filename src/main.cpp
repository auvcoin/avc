...
int64 nChainStartTime = 1468469261;
...
const string strMessageMagic = "auvcoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	{
        nSubsidy = 5100000 * COIN;
	}

    else if(nHeight > 100 && nHeight <= 43200)
    {
        nSubsidy = 0.0 * COIN;
    }
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
	...
	nRewardCoinYear = 1.4 * MAX_MINT_PROOF_OF_STAKE;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in auvcoin
    bool fStrictPayToScriptHash = true; // Always active in auvcoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "auvcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "target wwa vector ddg oW base target is fix ockI ssxc auvcoin8";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 743860 : 743860;
		...
		block.print();
		assert(block.hashMerkleRoot == uint256("0x0671395eb5b679fb777fee6d96ec028508b7bc8f079fb9b135a1394c0453cf58"));
...
unsigned char pchMessageStart[4] = { 0xb5, 0xf7, 0xa2, 0xdf };
