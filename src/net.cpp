...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "auvcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"54.199.163.39", "54.199.163.39"},
		  {"w1.auvcoin.com", "w1.auvcoin.com"},
		  {"w2.auvcoin.com", "w2.auvcoin.com"}
};
...
unsigned int pnSeed[] =
{
    0x44A4C136,0x9C331D73,0x9CF11C73,0x7B8D332E,0xC76D9B36,0x06858D72,0xE702B036,
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. auvcoin is probably already running."), addrBind.ToString().c_str());
        else
